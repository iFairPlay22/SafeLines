<template>
  <div class="d-flex justify-space-around align-center">
    <v-card
      ...
      flat
      color="transparent"
      class="d-flex flex-row align-center justify-center my-3"
    >
      <v-card-title class="display-2 text-center">Our magic solution</v-card-title>
      <v-card-text
        class="body-1"
